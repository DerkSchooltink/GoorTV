...
**YOU ARE IN: `goortv/polecats/radrat/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/goortv/` (rig root) or other directories
...
**Your mail address:** `goortv/polecats/radrat`
**Your rig:** goortv
**Your Witness:** `goortv/witness`
...
| Ask Witness for help | `gt mail send goortv/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`goortv/witness`) when:
...
```bash
gt mail send goortv/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
